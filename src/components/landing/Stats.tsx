  ...
  const stats = [
    {
      ...
      description: "Safe and honest community",
    },
    {
      icon: Users,
      number: 1540,
      suffix: "+",
      title: "Couples Formed",
      description: "Real stories of love and connection",
    },
    {
      icon: Globe,
      number: 35,
      ...
      description: "Cultural exchange and dating without borders",
    },
    {
      icon: CheckCircle2,
      number: 98,
      suffix: "%",
      title: "Compatibility",
      description: "Algorithm by real interests",
    },
  ];
